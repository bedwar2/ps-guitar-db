...
public class ModelRepository {
	...
	@Autowired ModelJpaRepository repository;

	/**
	 * Create
	 */
	public Model create(Model mod) {
		return repository.saveAndFlush(mod);
	}
	...
	public List<Model> getModelsInPriceRange(BigDecimal lowest, BigDecimal highest) {
		...
		return repository.findByPriceGreaterThanEqualAndPriceLessThanEqual(lowest,highest);
		/*
